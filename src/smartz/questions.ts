...
function extraBank(): Q[] {
  ...
  add("Entertainment", [
    ...
    ["Katseye is what kind of music act?", "A girl group", "A jazz trio", "A film studio", "A radio station"],
    ["Katseye was formed through a show with which companies?", "HYBE and Geffen", "Pixar and Disney only", "Nike and Adidas", "NASA and BBC"],
    ["How many members does Katseye have?", "Six", "Three", "Ten", "Two"],
    ["Which of these is a Katseye member?", "Sophia", "Billie only", "Adele", "Ed Sheeran"],
    ["Yoonchae is a member of which group?", "Katseye", "ABBA", "The Beatles", "One Direction"],
    ["Which early Katseye single shares its name with a light tap?", "Touch", "Splash", "Echo", "Sparkle"],
    ["Taylor Swift's 1989 album is named after what?", "Her birth year", "A highway number", "A bus route", "A hotel room"],
    ["Taylor Swift's huge stadium tour was called the what?", "Eras Tour", "World Cup Tour", "Space Race Tour", "Silent Tour"],
    ["Taylor Swift first became famous in which genre?", "Country", "Opera", "Heavy metal", "Baroque"],
    ["Folklore and Evermore are Taylor Swift albums known for what style?", "Indie folk", "Only marching band", "Only film scores", "Only nursery rhymes"],
    ["Benson Boone's huge 2024 hit is called what?", "Beautiful Things", "Ocean Eyes", "Hello", "Bad Guy"],
    ["Benson Boone often adds what to his live shows?", "Backflips", "Ice skating only", "Puppetry only", "Silent mime only"],
    ["Benson Boone is a singer from which country?", "The United States", "Brazil", "Japan", "Egypt"],
    ["Sabrina Carpenter's hit Espresso is mainly about what kind of song?", "A catchy pop single", "A national anthem", "A lullaby hymn", "A sports chant"],
    ["Sabrina Carpenter starred on which Disney sitcom as a kid?", "Girl Meets World", "Bluey", "The Simpsons", "Doctor Who"],
    ["Sabrina Carpenter's album Short n' Sweet is mainly what genre?", "Pop", "Classical piano", "Gregorian chant", "Sea shanty only"],
    ["Which Sabrina Carpenter song repeats the title as a request?", "Please Please Please", "Yesterday", "Let It Be", "Imagine"],
    ["Dua Lipa is a pop star from which country?", "The United Kingdom", "Peru", "Kenya", "Iceland"],
    ["Dua Lipa's album Future Nostalgia is known for what feel?", "Disco-pop", "Only country ballads", "Only opera arias", "Only film scores"],
    ["Which Dua Lipa song advises making an exit from a bad romance?", "New Rules", "Yesterday", "Let It Go", "Happy Birthday"],
    ["Levitating is a dance-pop hit by whom?", "Dua Lipa", "Mozart", "Beethoven", "Bach"],
    ["Dance The Night by Dua Lipa was made for which film world?", "Barbie", "Star Wars", "Harry Potter", "Frozen"],
  ]);
